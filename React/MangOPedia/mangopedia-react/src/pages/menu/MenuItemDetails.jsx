...
function MenuItemDetails() {
  ...
  const isValidatedItemId = !isNaN(menuItemId) && menuItemId > 0;

  //console.log(menuItemId, isValidatedItemId);
  ...
  const {
    ...
    skip: !isValidatedItemId,
  });

  if (!isValidatedItemId) {
    return (
            ...
            <div className="position-relative">
              <div className="rounded-4 overflow-hidden shadow-lg border bg-body position-relative">
                <img
                  ...
                  onError={(e) => {
                    e.target.src = "https://placeholder.com/100";
                  }}
                />
